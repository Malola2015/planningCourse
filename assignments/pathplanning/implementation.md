...
The algorithms will be implemented in Python and it is strongly recommended to use Git and make ```Commits/``` betweens the members of the group (max 3 members).
